...
export default function WhyBioNov() {
  return (
    <section id="why-bionov" className="relative overflow-hidden bg-white py-28">
      {/* soft gradient orbs echoing the PDF layout language */}
      <div aria-hidden className="absolute -left-32 top-10 h-80 w-80 rounded-full bg-nov-cyan/10 blur-2xl" />
      <div aria-hidden className="absolute -right-24 bottom-10 h-72 w-72 rounded-full bg-nov-pink/10 blur-2xl" />
