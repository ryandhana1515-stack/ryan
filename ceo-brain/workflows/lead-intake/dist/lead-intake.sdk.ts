  ...
  config: {
    ...
    parameters: {
      ...
      assignments: { assignments: [
        ...
        { id: 'cfg-tenant', name: 'default_tenant', value: "biogreen", type: 'string' },
        { id: 'cfg-aimode', name: 'default_ai_mode', value: 'live', type: 'string' },
        { id: 'cfg-agent', name: 'agent', value: "sales-qualification", type: 'string' },
        { id: 'cfg-agentv', name: 'agent_version', value: "1.0.0", type: 'string' }
      ] }
    },
    position: [220, 300]
  },
  output: [{ model: "claude-sonnet-4-6", notify_email: "ryandhana1515@gmail.com", default_tenant: "biogreen", default_ai_mode: 'live', agent: "sales-qualification", agent_version: "1.0.0", body: {} }]
});
