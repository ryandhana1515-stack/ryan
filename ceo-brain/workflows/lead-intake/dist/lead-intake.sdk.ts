    ...
    parameters: {
      ...
      workflowInputs: {
        ...
        value: {
          ...
          company_name: expr("{{ $('Finalize & Validate Result').item.json.lead.company_name ?? '' }}"),
          ...
          email: expr("{{ $('Finalize & Validate Result').item.json.lead.email ?? '' }}"),
          phone: expr("{{ $('Finalize & Validate Result').item.json.lead.phone ?? '' }}"),
          channel: expr("{{ $('Finalize & Validate Result').item.json.lead.channel }}"),
