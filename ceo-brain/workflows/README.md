...
Training Dashboard (browser) ─► Trainer API ─► vault (registry, playbooks) / John Chat Console / Website Builder
```
...
- **Website Builder** is generated by `website-builder/build.js` (same pattern). **John Chat Console** is
