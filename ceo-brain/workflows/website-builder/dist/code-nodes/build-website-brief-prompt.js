...
return [{ json: { input, user_prompt, started_at: now, config: { model: "claude-sonnet-4-6", agent: "website-builder", agent_version: "2.0.0" }, execution_id: String($execution.id), workflow_id: String($workflow.id) } }];
