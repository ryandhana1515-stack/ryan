...
updated: 2026-09-26T16:28:24.991Z
---
# Management view — Sun, 27 Sept, 12:28 am SGT
...
| | |
|---|---|
| Real leads (new 24 h) | 0 (0) |
| Pipeline | empty |
| Open tasks | 1 |
| Approvals waiting | 1 |
| Exceptions open | 0 |
| Website builds | building 0 · built 2 · failed 0 |
| Agent runs 24 h | 34 (failed 0, AI fallback 16) |
| Test leads excluded | 17 |

## Unresolved (2, 1 high)

### Approvals waiting (1)
- **APPROVAL: build MEDICAL business website for Dashboard tester** · 23 h · `task_web_lead_dash_v2medtest1`

### AI fallback (1)
- 16 run(s) used the rule fallback (AI unavailable)
