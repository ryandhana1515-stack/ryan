...
- [ ] **(Ryan)** attach the n8n, Lovable, Higgsfield and Kling connectors to the Claude routine "Zaphiel — Website Build Worker" (claude.ai → Routines). n8n credentials for Lovable are impossible (Lovable blocks hosted OAuth clients); the n8n runner is superseded
